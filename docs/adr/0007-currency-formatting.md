...
Rules:
- **Decimals are practical, not blindly ISO:** `IQD = 0` and `SAR = 0` (operator decision — whole-number COD convention), `KWD/BHD/OMR/JOD/TND/LYD = 3`, most others `2`, `DJF/KMF = 0`.
